package com.itechart.careers.tests;
...
public class CareersTest extends TestBase {
  ...
  public void testSendCV(CVData cvData) throws Exception {
    ...
    assertTrue(app.careers()
                  .isElementOnPage(By.xpath("//form/div[@class='result']/h2[contains(text(), 'Perfect click. You rock!')]")));
  }
}
